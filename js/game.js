...
function showAnswerLarge(answer) {
  ...
  // Only show the non-imposter question to the host
  // This helps the host identify who might have gotten the imposter question
  if (promptPair && MULTIPLAYER.isHost) {
